...
public class CustomVodControlView extends FrameLayout implements IControlComponent, View.OnClickListener, SeekBar.OnSeekBarChangeListener {
    ...
    //总时长 当前时长 播放倍速
    private TextView mTotalTime, mCurrTime, mSpeed;
    //全屏按钮
    ...
    public CustomVodControlView(@NonNull Context context) {
        super(context);
    }

    public CustomVodControlView(@NonNull Context context, boolean isLive) {
        super(context);
        this.isLive = isLive;
    }

    public CustomVodControlView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public CustomVodControlView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
